...
func InitEnv() {
	...
	RelayConnectTimeout = GetEnvOrDefault("RELAY_CONNECT_TIMEOUT", 10)
	RelayResponseHeaderTimeout = GetEnvOrDefault("RELAY_RESPONSE_HEADER_TIMEOUT", 20)
	RelayNonStreamTimeout = GetEnvOrDefault("RELAY_NON_STREAM_TIMEOUT", 0)
	RelayFailoverBudget = GetEnvOrDefault("RELAY_FAILOVER_BUDGET", 90)
...
func initConstantEnv() {
	constant.StreamingTimeout = GetEnvOrDefault("STREAMING_TIMEOUT", 90)
	constant.StreamFirstEventTimeout = GetEnvOrDefault("STREAM_FIRST_EVENT_TIMEOUT", 35)
