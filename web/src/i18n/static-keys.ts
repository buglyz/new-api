...
export const STATIC_I18N_KEYS = [
  ...
  'Personal channel and model reliability state',
  'Probe attention channels',
  'Probe and recover',
  'Reset temporary circuits',
  'Close all circuit breakers',
  'Temporary Circuits',
  'Process-local state',
  'No active temporary circuits',
  'Channel test task queued',
  'Temporary circuits reset',
  'All circuit breakers closed',
  'Route Preview',
  'Request Path',
  'Preview',
  'Route preview failed',
  'Group and model are required',
  'No route candidates',
  'Route eligible',
  'Cooling down',
  'Open',
